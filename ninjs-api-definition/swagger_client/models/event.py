...
class Event(object):
    ...
    swagger_types = {
        ...
        'altids': 'EventAltids',
        'rendition_type': 'EventRenditionType',
        'commissionedby': 'list[EventCommissionedby]',
    ...
    def __init__(self, uri=None, type=None, title=None, by=None, language=None, descriptions=None, altids=None, rendition_type=None, commissionedby=None, eventdetails=None, headlines=None, slugline=None, places=None, people=None, subjects=None, plannedcoverage=None):  # noqa: E501
        ...
        self._altids = None
        self._rendition_type = None
        self._commissionedby = None
        ...
        if commissionedby is not None:
            self.commissionedby = commissionedby
    ...
    @property
    def rendition_type(self):
        """Gets the rendition_type of this Event.  # noqa: E501


        :return: The rendition_type of this Event.  # noqa: E501
        :rtype: EventRenditionType
        """
        return self._rendition_type

    @rendition_type.setter
    def rendition_type(self, rendition_type):
        """Sets the rendition_type of this Event.


        :param rendition_type: The rendition_type of this Event.  # noqa: E501
        :type: EventRenditionType
        """

        self._rendition_type = rendition_type

    @property
    def commissionedby(self):
        """Gets the commissionedby of this Event.  # noqa: E501


        :return: The commissionedby of this Event.  # noqa: E501
        :rtype: list[EventCommissionedby]
        """
        return self._commissionedby

    @commissionedby.setter
    def commissionedby(self, commissionedby):
        """Sets the commissionedby of this Event.


        :param commissionedby: The commissionedby of this Event.  # noqa: E501
        :type: list[EventCommissionedby]
        """

        self._commissionedby = commissionedby
